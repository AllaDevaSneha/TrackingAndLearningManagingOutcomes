...
<body>
    <div class="navbar">
        ...
        <label class="signuplabel" onClick="StudentCourseMapping()">StudentCourseMapping</label>
        <label class="signuplabel" onClick="FacultyCourseMapping()">FacultyCourseMapping</label>
